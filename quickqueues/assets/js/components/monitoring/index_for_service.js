var monitoring_dashboard = new Vue({
    ...
    methods: {
        ...
        {
			axios.get(api_url+'agent/get_cached_realtime_status_for_all_agents/')
                .then(response => 
                {
        ...
        {
						axios.get(api_url+'queue/get_cached_realtime_data/')
                            .then(response => {
        ...
        {
			axios.get(api_url+'agent/get_cached_current_calls_for_all_agents')
            .then(response => {
                if (typeof(response.data.data) == 'object') 
                {
        ...
        {
			axios.post(api_url+'agent/get_cached_stats_for_all_queues/',this.form_data)
            .then(response => {
