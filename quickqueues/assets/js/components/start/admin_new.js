var start = new Vue({
    ...
    computed: {
        ...
        sla_count_grate_than_20_percent: function() {
            if (this.total_stats.sla_count_total > 0) {
                let grate_than_20 = (this.total_stats.sla_count_grate_than_20 / this.total_stats.sla_count_total) * 100;
                return grate_than_20.toFixed(2)+'%';
            } else {
                return '0%';
            }
        },
