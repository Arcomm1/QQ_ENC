...
$('#created_at_gt').datetimepicker({format: 'Y-m-d 00:00:00'});
$('#created_at_lt').datetimepicker({format: 'Y-m-d 23:59:59'});
$('#due_at_gt').datetimepicker({format: 'Y-m-d 00:00:00'});
$('#due_at_lt').datetimepicker({format: 'Y-m-d 23:59:59'});
