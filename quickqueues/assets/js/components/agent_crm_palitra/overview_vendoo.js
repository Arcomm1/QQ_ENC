var agent_crm = new Vue({
    ...
    methods: {
        ...
        get_queue_stats: function () {
            ...
            axios.post(api_url+'queue/get_stats/'+queue_id)
                .then(response => {
                    ...
                    this.gage_without_service.refresh(response.data.data.calls_without_service,response.data.data.calls_total,0);
            ...
            axios.get(api_url+'queue/get_agent_overview/'+queue_id)
                ...
                .then(() => {
                    ...
                    for (a in this.agents) {
                        ...
                        if (this.agents[a].realtime.Status != 2 && this.agents[a].realtime.Status != 4) {
        ...
        refresh_stats: function () {
            ...
            setInterval( () => this.get_agents(), 3000);
            setInterval( () => this.get_queue_realtime(), 3000);

            setInterval( () => this.get_realtime_status(), 3000);
            setInterval( () => this.get_current_call(), 3000);
        },
    },
    ...
    mounted () {
        ...
        this.gage_without_service = new JustGage({
            id: "without_service",
            value: 100,
            min: 0,
            max: 100,
            title: lang['calls_without_service'],
            levelColors: [get_colors('danger')],
        });
