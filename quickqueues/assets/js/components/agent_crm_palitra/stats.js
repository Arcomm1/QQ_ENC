var agent_crm = new Vue({
    ...
    data () {
        return {
            ...
            pause_events: {},
            pause_events_loading: true,
            pause_events_error: false,
    ...
    methods: {
        ...
        // Get pause events
        get_pause_events: function() {
            this.pause_events_loading = true;
            axios.post(api_url+'agent/get_pause_events/'+agent_id, this.form_data)
                .then(
                    response => {
                        this.pause_events = response.data.data;
                    })
                .finally(() => this.pause_events_loading = false)
        },
