var agent_crm = new Vue({
    ...
    methods: {
        ...
        save_current_call: function () {
            ...
            future_call_form.append('custom_1', this.future_call.custom_1);
            future_call_form.append('custom_2', this.future_call.custom_2);
            future_call_form.append('custom_3', this.future_call.custom_3);
            future_call_form.append('custom_4', this.future_call.custom_4);
