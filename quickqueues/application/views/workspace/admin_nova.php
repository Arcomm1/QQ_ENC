            ...
            <div class="card border-primary">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col">
                            <div class="alert alert-success d-flex justify-content-between">
                                ...
                                <h3 v-if="!dids.includes(call_in_progress.ConnectedLineNum)">{{ call_in_progress.CallerIDNum }}</h3>
                    ...
                    <div class="row mb-2">
                        ...
                        <?php if ($config->app_call_subcategories == 'yes') { ?>
                            <div class="col">
                                <label for="subcategory_id"><?php echo lang('call_subcategory'); ?></label>
                                <select v-model="future_call.subcategory_id" class="form-control mb-2" id="subcategory_id" name="subcategory_id">
                                    <option value=""></option>
                                </select>
                            </div>
                        <?php } ?>
                    ...
                    <div class="row mb-2">
                        <div class="col">
                            ...
                            <input type="text" name="custom_1" id="custom_1" class="form-control"/>
                        </div>
                        <div class="col">
                            <label for="custom_2"><?php echo lang('custom_2'); ?></label>
                            <input type="text" name="custom_2" id="custom_2" class="form-control"/>
                        </div>
                    </div>
                    <div class="row mb-2">
                        <div class="col">
                            <label for="custom_3"><?php echo lang('custom_3'); ?></label>
                            <input type="text" name="custom_3" id="custom_3" class="form-control"/>
                        </div>
                        <div class="col">
                            <label for="custom_4"><?php echo lang('custom_4'); ?></label>
                            <input type="text" name="custom_4" id="custom_4" class="form-control"/>
                        </div>
                    </div>
